...
const Blog = () => {
  ...
  useEffect(() => {
    ...
    return (
      ...
      >
        <h1 className="text-2xl font-bold">Q.1 what are the Difference between SQL and NoSQL?</h1>
        <div className="  my-2">
          <p className="font-bold mx-2">Answer: </p>
          <ol className='list-decimal mb-2 mx-2 md:mx-4'>
          <li> <span className='font-bold'>SQL</span> databases are primarily called as Relational Databases (RDBMS);
          whereas <span className='font-bold'>NoSQL</span> database are primarily called as non-relational or distributed database.
          </li>
          <li> <span className='font-bold'>SQL</span> These databases have fixed or static or predefined schema;
          whereas <span className='font-bold'>NoSQL</span> database has dynamic schema for unstructured data.
          </li>
          <li> <span className='font-bold'>SQL</span>databases are not suited for hierarchical data storage;
          whereas <span className='font-bold'>NoSQL</span> databases are best suited for hierarchical data storage.
          </li>
          <li> <span className='font-bold'>SQL</span> databases Vertically Scalable;
          whereas <span className='font-bold'>NoSQL</span> database Horizontally scalable.
          </li>
          <li> <span className='font-bold'>SQL</span>Follows ACID property;
           <span className='font-bold'>NoSQL</span> database follows CAP(consistency, availability, partition tolerance).
          </li>
          </ol>
        </div>
      </div>
  ...
  <table className="table-normal  w-full">
    ...
    <tbody>
      ...
      <tr className="hover">
        ...
        <td>JS is a programming language that is used for writing scripts on the website</td>
